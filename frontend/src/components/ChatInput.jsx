  ...
  return (
    <div className={`p-4 border-t ${isDark ? 'border-gray-700 bg-gray-900' : 'border-gray-200 bg-white'} shadow-inner transition-colors duration-200`}>
      <form onSubmit={handleSubmit} className="relative">
        <div className={`flex flex-col rounded-lg overflow-hidden border focus-within:ring-2 transition-all duration-200 ${
            isDark
        ...
        >
          <textarea
            ...
            className={`flex-grow py-3 px-4 bg-transparent resize-none focus:outline-none min-h-[48px] max-h-[200px] ${
          ...
          <div className={`border-t px-3 py-2 flex items-center justify-between transition-colors duration-200 ${
            ...
            <div className="relative w-10 h-10">
              {/* Botón de voz */}
              <div
                className={`absolute inset-0 flex items-center justify-center transition-all duration-300 transform -ml-2 ${
                  !input.trim() && !isLoading ? 'opacity-100 scale-100 pointer-events-auto' : 'opacity-0 scale-0 pointer-events-none'
                }`}
              >
              ...
              <button
                type="submit"
                className={`absolute inset-0 flex items-center justify-center w-10 h-10 transition-all duration-300 transform bg-blue-600 text-white rounded-full ${
                  input.trim() || isLoading ? 'opacity-100 scale-100 pointer-events-auto hover:bg-blue-700 hover:scale-110' : 'opacity-0 scale-0 pointer-events-none'
